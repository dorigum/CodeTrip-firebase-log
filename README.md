...
- Firebase Hosting 배포 URL 접속 확인: https://newagent-9c2a8.web.app
...
- [Firebase 수정 로그](documents/Firebase/Firebase_수정로그.md)
- [Firebase 상세내역서](documents/Firebase/Firebase_상세내역서.md)
...
- `develop` 브랜치는 필수 흐름으로 사용하지 않으며, 장기 실험이나 큰 변경을 분리할 때만 선택적으로 사용합니다.
- 일반 작업은 `main`에서 바로 진행하고, 위험도가 있는 작업은 짧은 `feature/...` 브랜치에서 작업 후 `main`으로 병합합니다.
