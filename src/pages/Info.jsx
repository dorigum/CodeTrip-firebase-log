...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      '현재 진행 중이거나 곧 열리는 전국 축제와 행사를 날짜순으로 정렬해 보여줍니다. 관심 있는 축제를 클릭하면 상세 정보로 바로 이동합니다.',
    icon: 'celebration',
    path: '/festivals',
        ...
        <div className="mx-auto max-w-5xl space-y-8 sm:space-y-12">
          <InfoReveal className="mx-auto max-w-4xl space-y-3 text-center">
            ...
            <p className="text-sm leading-relaxed text-slate-500 sm:text-base">
              정확한 목적지를 정하지 못한 상태에서도 여행 후보를 발견하고,<br className="sm:hidden" />저장·비교·일정 초안까지 자연스럽게 이어갈 수 있습니다.
            </p>
          </InfoReveal>
