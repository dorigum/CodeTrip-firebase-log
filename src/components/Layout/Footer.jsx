  ...
  <footer className="w-full border-t border-outline-variant/15 bg-background px-5 py-5 pb-20 text-center md:px-10 md:py-6 md:pb-6 md:text-left">
    <div className="relative mx-auto max-w-6xl">
      ...
      <div className="max-w-2xl">
        ...
        <div className="mt-3 flex flex-wrap justify-center gap-x-3 gap-y-1 text-[9px] leading-4 text-on-secondary-container/55 sm:justify-start sm:text-[10px]">
      ...
      <div className="mt-4 border-t border-outline-variant/10 pt-3 text-[9px] uppercase tracking-[0.1em] text-on-secondary-container/50 sm:text-[10px]">
