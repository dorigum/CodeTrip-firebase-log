  ...
  <footer className="w-full border-t border-outline-variant/15 bg-background px-5 py-5 pb-20 text-center md:px-10 md:py-6 md:pb-6 md:text-left">
    <div className="relative mx-auto max-w-6xl">
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-[11px] leading-5 text-on-secondary-container/75 sm:text-xs md:whitespace-nowrap">
          여행지를 고르기 어려운 순간부터 일정 저장과 여행 준비까지,<br className="md:hidden" />조건을 바탕으로 나만의 여행 결정을 돕습니다.
        </p>
