...
| `CodeTrip_2026_관광데이터_공모전_기능설명서_최종_20260917.pptx` | PPTX | 1003594 | `701E80856624E2982277C2E135405F1566D0A12B48B2EC5C09098D17876377F8` | 최신 기능·검증 결과 반영 후보 |
| `CodeTrip_2026_관광데이터_공모전_기능설명서_최종_20260917.pdf` | PDF | 385075 | `CEBE45D6E321F7B0F6060CE3E9577D0254889C6D7EF7030046A128EEF02BD834` | 5페이지·10MB 미만 렌더 검토 후보 |
| `CodeTrip_2026_관광데이터_공모전_기능설명서_최종_20260917_r2.pptx` | PPTX | 1003690 | `6C812F04D4403C47B0D4BAA8CBBB095CDD0592C2A4F2E1709AEAC699842D7BCF` | API 활용 설명 보강 후보 |
| `CodeTrip_2026_관광데이터_공모전_기능설명서_최종_20260917_r2.pdf` | PDF | 386962 | `9B79F04ACE064F2B0755B7F22FD51F44272CC19072C1DDD6C1E5053A2946091E` | API 활용 설명 보강, 5페이지 PDF |
...
| 항목 | 결과 | 비고 |
|---|---|---|
| 제공 양식 기반 | 통과 | 5페이지 제출 항목 정리 초안을 복제해 내용만 갱신했습니다. |
| 팀명 placeholder | 통과 | `CodeTrip`으로 교체했습니다. |
| 페이지 수 | 통과 | PDF 기준 5페이지입니다. |
| 파일 용량 | 통과 | PDF 385075 bytes로 10MB 미만입니다. |
| 구조·레이아웃·폰트 | 통과 | PPTX 무결성, 5페이지, 맑은 고딕 111개 텍스트 스크립트를 검사했고 경고가 없습니다. |
| 시각 검토 | 통과 | PDF 렌더링으로 서비스 소개·기능 흐름·데이터 활용·대표 화면 배치를 확인했습니다. |
| 제출 보류 항목 | 남음 | 3번 슬라이드의 기존 캡처는 최신 로그인 후 AI·폴더·커뮤니티 화면으로 교체하고, 제출 페이지 입력값·OpenAPI 키 입력을 사용자가 최종 확인해야 합니다. |

## 2026-09-18 API 설명 개정

- 한국관광공사 OpenAPI에는 목록·상세·이미지·지역 코드·축제/행사 조회와 홈 추천용 관광 사진 제공 목적을 적었습니다.
- 기타 API에는 날씨·위치명·지도·AI 일정 초안·Firebase 인증·저장·배포의 역할을 적었습니다.
- PPTX/PDF 모두 5페이지이며, 5번 슬라이드 렌더링으로 텍스트 잘림이 없는 것을 확인했습니다.
