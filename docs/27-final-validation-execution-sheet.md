...
| AI-SEC-04 | Gemini 공개 생성 보안 게이트 | AI-SEC-01~AI-SEC-03, AI-SEC-07~AI-SEC-11이 미완료이면 공개 URL의 Gemini 신규 생성을 제출 통과 상태로 보지 않는다. | 부분 통과 | Functions·Hosting 배포 완료, 미인증 401 차단 확인 | 로그인 상태 실제 AI 생성 smoke test 필요 |
