...
| G6 AI 공개 시연 보안 | 공개 배포 환경에서 클라이언트 키 노출 차단 필요 | Callable Function·Secret·Hosting 배포 완료, 신규 키 Secret version 2 반영, 배포 산출물 키 미포함, 미인증 401 차단, 인증 성공 smoke test 확인, 기존 temp 키 삭제 검증 필요 | 부분 완료 |
...
| 7 | Gemini 공개 AI 시연 보안 게이트 | 기존 노출 가능 키 폐기 | 기존 키 폐기·거부 확인 완료 | `docs/10-ai-harness-engineering.md`, `docs/24-submission-copywriting.md`, `docs/27-final-validation-execution-sheet.md` |
