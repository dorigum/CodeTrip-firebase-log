...
| G6 AI 공개 시연 보안 | 공개 배포 환경에서 클라이언트 키 노출 차단 필요 | Callable Function·Secret·Hosting 배포 완료, 신규 키 Secret version 2 반영, 배포 산출물 키 미포함, 미인증 401 차단, 인증 성공 smoke test 확인, 기존 temp 키 삭제 완료 | 완료 |
