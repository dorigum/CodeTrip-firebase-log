...
- [2026-07-29](project-log/2026-07-29.md): 날씨 API와 위치명 역지오코딩 API에 공통 캐시 레이어 적용, 좌표 반올림 기반 캐시 키와 TTL 정책 정리, README/배포 가이드/공모전 제출 체크리스트 최신화, AI 코스 상세 문서와 폴더 체크리스트 연결, AI 코스 장소 출처 구분 표시 개선, AI 코스 상세 날짜별 탭 추가, AI 코스 장소 카드 접기/펼치기 추가
