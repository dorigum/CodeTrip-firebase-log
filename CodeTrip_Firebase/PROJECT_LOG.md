...
- [2026-07-24](project-log/2026-07-24.md): Gemini 기본 모델 Flash-Lite 전환, API 재시도 로직 보정, AI 코스 상세 보기와 레거시 AI 메모 마이그레이션, 위시리스트 안내 UI 및 폴더 조건 자동 반영, 관광공사 contentId 재검증과 공식 장소 정보 저장 보정
