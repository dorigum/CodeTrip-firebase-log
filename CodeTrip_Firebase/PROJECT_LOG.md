...
- [2026-09-08](project-log/2026-09-08.md): CodeRabbit PR #33 피드백에 따라 게시글 삭제 진행 중 확인 모달이 재렌더링돼도 키보드 포커스가 모달 밖으로 이동하지 않도록 포커스 복원 시점을 보완했습니다. 또한 Database Trigger의 비동기 요약 삭제 전에도, 삭제 직후 게시판 목록에서 해당 카드를 즉시 숨기도록 처리했습니다.
